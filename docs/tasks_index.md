...
| T010 | web e2e 基建(vite proxy+web fixture+示范 spec)  | backlog | claude | task_t010_web_e2e_infrastructure     | 依赖 T009                                     |
| T011 | web spec 批量迁移(specs→web,~15 个)             | backlog | claude | task_t011_migrate_web_specs          | 依赖 T010                                     |
