...
const UI_ICONS = {
    ...
    eye_off:
        '<path d="M3 3l18 18M10.6 10.6a3 3 0 0 0 4 4M9.4 5.3A9.4 9.4 0 0 1 12 5c6 0 9.5 6.5 9.5 6.5a16.6 16.6 0 0 1-3.2 3.9M6.5 6.6A16.5 16.5 0 0 0 2.5 12S6 18.5 12 18.5a9.2 9.2 0 0 0 2.9-.5"/>',
    ...
    feedback:
        '<path d="M21 11.5a7.5 7.5 0 0 1-10.8 6.74L4.5 20l1.27-4.16A7.5 7.5 0 1 1 21 11.5z"/>',
...
const VENDOR_ICONS = {
    overview: (
        s,
    ) => `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="#3d7afd" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
    ...
    claude: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24"><g stroke="#d97757" stroke-width="2" stroke-linecap="round"><line x1="12" y1="3" x2="12" y2="21"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="5.6" y1="5.6" x2="18.4" y2="18.4"/><line x1="18.4" y1="5.6" x2="5.6" y2="18.4"/><line x1="12" y1="2.5" x2="12" y2="21.5" transform="rotate(22.5 12 12)"/><line x1="12" y1="2.5" x2="12" y2="21.5" transform="rotate(67.5 12 12)"/></g><circle cx="12" cy="12" r="2.4" fill="#d97757"/></svg>`,
    codex: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none"><path d="M12 2.6l8 4.4v9.9l-8 4.5-8-4.5V7z" fill="#eef1ff" stroke="#6172f3" stroke-width="1.4"/><path d="M12 12.4l8-4.6M12 12.4v9.1M12 12.4L4 7.8" stroke="#6172f3" stroke-width="1.4" stroke-linejoin="round"/><path d="M12 2.6l8 4.4-8 5.4-8-5.4z" fill="#8b9bff"/></svg>`,
    glm: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="#3d7afd"><circle cx="12" cy="4" r="1.5"/><circle cx="12" cy="20" r="1.5"/><circle cx="4" cy="8" r="1.5"/><circle cx="20" cy="8" r="1.5"/><circle cx="4" cy="16" r="1.5"/><circle cx="20" cy="16" r="1.5"/><circle cx="12" cy="12" r="2.4"/><circle cx="7" cy="12" r="1.2" opacity=".6"/><circle cx="17" cy="12" r="1.2" opacity=".6"/></svg>`,
    deepseek: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none"><path d="M3 13c2.5 0 4-1.2 5-3 .8 2.4 3 4 6 4 2.2 0 4-.7 5.5-2-.3 4-3.8 6.8-8 6.8-3.7 0-6.8-2.4-8.5-5.8z" fill="#4d6bfe"/><circle cx="15.5" cy="10.5" r="1.1" fill="#fff"/></svg>`,
    minimax: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="#e23744" stroke-width="2" stroke-linecap="round"><path d="M3 12c1.5 0 1.5-5 3-5s1.5 11 3 11 1.5-13 3-13 1.5 9 3 9 1.5-3 3-3"/></svg>`,
    tavily: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21V8" stroke="#3d7afd"/><path d="M12 8l-4 4M12 8l4 4" stroke="#3d7afd"/><path d="M12 3l5 4" stroke="#f5a524"/><path d="M5 9l5-2.5" stroke="#22c55e"/></svg>`,
    /* orange shield — Brave Search placeholder */
    brave: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24"><path d="M12 2.6l6.2 2.1.7 7.7c.2 2.5-1.1 4.9-3.3 6.1L12 21.4l-3.6-2.9c-2.2-1.2-3.5-3.6-3.3-6.1l.7-7.7z" fill="#fb542b"/><path d="M12 8.1l2.3 2.5-2.3 4.2-2.3-4.2z" fill="#fff"/></svg>`,
    /* four-point sparkle */
    gemini: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24"><path d="M12 2.2c.5 4.6 2.6 7.2 7.6 7.8-5 .6-7.1 3.2-7.6 7.8-.5-4.6-2.6-7.2-7.6-7.8 5-.6 7.1-3.2 7.6-7.8z" transform="translate(0 2)" fill="#3a72f0"/></svg>`,
    /* dark rounded square w/ crescent — Kimi placeholder */
    kimi: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24"><rect x="2.5" y="2.5" width="19" height="19" rx="5.5" fill="#17181d"/><path d="M15 8.2A4.6 4.6 0 1 0 15 15.8 5.8 5.8 0 0 1 15 8.2z" fill="#fff"/></svg>`,
    /* blue upward arc — Antigravity placeholder */
    antigravity: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9.3" fill="#2f6df0"/><path d="M8 8v3.4a4 4 0 0 0 8 0V8" stroke="#fff" stroke-width="1.9" stroke-linecap="round"/><path d="M12 16.4v2.2" stroke="#fff" stroke-width="1.9" stroke-linecap="round"/></svg>`,
    /* amber rounded square w/ concentric lens — MiMo placeholder */
    mimo: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24"><rect x="2.5" y="2.5" width="19" height="19" rx="5.5" fill="#ff7a45"/><circle cx="12" cy="12" r="5.2" fill="none" stroke="#fff" stroke-width="1.8"/><circle cx="12" cy="12" r="1.7" fill="#fff"/></svg>`,
    /* segmented donut — CPA Manager data source */
    cpa: (s) =>
        `<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke-width="4.2"><path d="M12 5A7 7 0 0 1 19 12" stroke="#3d7afd"/><path d="M19 12A7 7 0 0 1 12 19" stroke="#22c55e"/><path d="M12 19A7 7 0 0 1 5 12" stroke="#f5a524"/><path d="M5 12A7 7 0 0 1 12 5" stroke="#d97757"/></svg>`,
};
