        ...
        accounts: [
            {
                ...
                e5: 0.4,
                ew: 0.65,
                mcp: { value: 58, max: 1000, reset: "6/8 19:00" },
            },
            {
                name: "研究账号",
                key: "sk-****q7r8s9t0u1v2",
                ...
                e5: 0.4,
                ew: 0.65,
                mcp: { value: 37, max: 1000, reset: "6/8 19:00" },
            },
        ],
        h5: 34,
        week: 41,
        ...
        accounts: [
            {
                ...
                ew: 0.5,
                balanceOnly: true,
                balance: { value: 52, max: 100, reset: "" },
            },
        ],
        h5: 7,
        week: 22,
...
function vendorChart(id) {
    const seedPeak =
        { claude: 14, codex: 16, glm: 13, deepseek: 12, minimax: 15, gemini: 14, tavily: 14 }[id] ||
        14;
    return {
