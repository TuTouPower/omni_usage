    ...
    return (
        <div className="ad-field">
            ...
            <input
                ...
                placeholder={placeholder || "例如：工作账号"}
            />
        </div>
    );
}
        ...
        <>
            ...
            <div className="ad-field">
                ...
                <div className="ad-hint">
                    ...
                    密钥仅加密保存在本地{meta.docs ? `，在 ${meta.docs} 获取` : ""}
                </div>
            </div>
            <div className="ad-field">
                <label className="ad-label">
        ...
        <>
            ...
            <div className="ad-field">
                ...
                <div className="aa-tabs">
                    <button
                        className={"aa-tab" + (method === "web" ? " on" : "")}
                    ...
                    <button
                        className={"aa-tab" + (method === "cookie" ? " on" : "")}
            ...
            {phase === "scanning" ? (
                ...
                <div className="scan-found">
                    <div className="sf-head">
                        ...
                        <button className="sf-rescan" onClick={runScan}>
                    ...
                    {scan.found.map((f) => {
                        ...
                        return (
                            <button
                                key={f.id}
                                className={
                                    "found-row" + (on ? " on" : "") + (f.fresh ? "" : " stale")
                                }
                                onClick={() => f.fresh && toggle(f.id)}
                                disabled={!f.fresh}
                            >
                                ...
                                <span className="fr-body">
                                    ...
                                    <span className="fr-path">
                                        <Icon name="file" size={11} strokeWidth={1.7} />
                                        {f.path}
                                    </span>
                                </span>
                                <span className="fr-meta">
                                    <span className="fr-type">{f.type}</span>
                                    <span className={"fr-exp" + (f.fresh ? "" : " bad")}>
                                        {f.expires}
                                    </span>
                                </span>
                            </button>
...
function AddAccountDialog({ vendorId, onClose }) {
    ...
    return (
        <AADialog onClose={onClose} wide={wide}>
            <AAHead
                vendorId={vendorId}
                title={`添加 ${meta.name} 账号`}
                sub={subByAuth[auth]}
                onClose={onClose}
            />
            <div className="ad-body">
                {auth === "apikey" && (
                    <ApiKeyBody vendorId={vendorId} name={name} setName={setName} />
                )}
                {auth === "session" && (
                    <SessionBody vendorId={vendorId} name={name} setName={setName} />
                )}
            ...
            <div className="ad-foot">
                {rows.length > 0 && (
                    <button
                        ...
                        style={changedCount ? undefined : { opacity: 0.45, cursor: "default" }}
                    >
                        <Icon name="reset" size={14} strokeWidth={1.9} />
                        全部恢复默认
                    </button>
                )}
                <div className="ad-foot-r">
