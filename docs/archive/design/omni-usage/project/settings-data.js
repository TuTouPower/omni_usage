...
const AUTH_APIKEY_META = {
    ...
    brave: {
        ...
        docs: "brave.com/search/api → Subscriptions",
    },
    minimax: {
        prefix: "",
        endpoint: "https://api.minimaxi.com",
        docs: "minimaxi.com → 账户管理 → 接口密钥",
    },
};
...
const AUTH_SESSION_META = {
    mimo: {
        ...
        cookieKeys: ["serviceToken", "cUserId"],
    },
    kimi: {
        host: "kimi.com",
...
const AUTH_LOCAL_SCAN = {
    claude: {
        ...
        found: [
            ...
            {
                id: "cl-b",
                path: "~/.config/claude/auth.json",
                account: "team@acme.io",
                type: "OAuth · Max",
                expires: "已过期 · 需重新登录",
                fresh: false,
            },
...
const VENDOR_RAW_LABELS = {
    deepseek: [{ raw: "balance_cny", def: "账户余额" }],
    gemini: [
...
const ACCT_NORMAL = [
    { id: "claude", accounts: [{ name: "个人账号", key: "sk-ant-****1111", source: "direct" }] },
    {
        id: "codex",
        accounts: [
    ...
    { id: "kimi", accounts: [{ name: "个人账号", key: "sk-kimi-****3333", source: "direct" }] },
    {
        id: "mimo",
        accounts: [{ name: "个人账号", key: "mimo_session_****a1b2", source: "direct" }],
    },
];
...
const ACCT_CPA = [
    ...
    { id: "gemini", accounts: [{ name: "个人账号", key: "sk-gem-****1111", source: "cpa" }] },
    { id: "kimi", accounts: [{ name: "个人账号", key: "sk-kimi-****3333", source: "cpa" }] },
    {
        id: "antigravity",
        accounts: [
...
const CPA_DISCOVERED = [
    ...
    { id: "gemini", accounts: [{ name: "个人账号", key: "sk-gem-****1111" }] },
    { id: "kimi", accounts: [{ name: "个人账号", key: "sk-kimi-****3333" }] },
    {
        id: "antigravity",
        accounts: [
...
const CPA_DISCOVERED_2 = [
    { id: "claude", accounts: [{ name: "私人账号", key: "sk-ant-****7777" }] },
    { id: "gemini", accounts: [{ name: "个人账号", key: "sk-gem-****7777" }] },
    { id: "deepseek", accounts: [{ name: "个人账号", key: "sk-ds-****7777" }] },
];
...
const CONNECTIONS = [
    { type: "vendor", id: "claude", accounts: [{ id: "cl-1", name: "个人账号", status: "ok" }] },
    {
        type: "vendor",
        id: "glm",
        accounts: [
    ...
    { type: "vendor", id: "deepseek", accounts: [{ id: "ds-1", name: "个人账号", status: "ok" }] },
    { type: "vendor", id: "tavily", accounts: [{ id: "tv-1", name: "个人账号", status: "ok" }] },
    { type: "vendor", id: "brave", accounts: [{ id: "br-1", name: "个人账号", status: "ok" }] },
    { type: "vendor", id: "mimo", accounts: [{ id: "mm-1", name: "个人账号", status: "auth" }] },
